      ...
      <div class="flex flex-wrap lg:items-center -m-8">
        <div class="w-full md:w-1/2 p-8">
          <div class="md:max-w-md">
            ...
            <h2 class="font-heading mb-6 text-4xl md:text-5xl text-gray-100 font-black tracking-tight">All-in-one,
              next-gen Crypto experience.</h2>
            <p class="mb-5 text-gray-500 font-bold">Simple steps. No traps you can fall into. Store cryptos safely.
              Receive and send cryptos easily and quickly.</p>
              ...
              <div class="flex flex-wrap -m-3">
                <div class="w-full p-3">
                  <div class="flex flex-wrap -m-4">
                    ...
                    <div class="flex-1 p-4">
                      ...
                      <p class="text-gray-500 font-bold">Create an account and your wallets will be created in
                        minutes. </p>
                    </div>
                  </div>
                </div>
                <div class="w-full p-3">
                  <div class="flex flex-wrap -m-4">
                    ...
                    <div class="flex-1 p-4">
                      <h3 class="font-heading mb-3 text-2xl text-gray-100 font-bold">Receive</h3>
                      <p class="text-gray-500 font-bold">Receive Cryptos in your wallet. After receiving coins you'll
                        get notified.</p>
                    </div>
                  </div>
                </div>
                <div class="w-full p-3">
                  <div class="flex flex-wrap -m-4">
                    ...
                    <div class="flex-1 p-4">
                      <h3 class="font-heading mb-3 text-2xl text-gray-100 font-bold">Send</h3>
                      <p class="text-gray-500 font-bold">Two clicks and the Cryptos will be send to the receiver.
                        Validations and check ups will be finished in seconds.</p>
                    </div>
                  </div>
                </div>
              </div>
